...
A clean and interactive Currency Converter web application built with vanilla HTML, CSS, and JavaScript. It fetches real-time foreign exchange rates and dynamically updates country flags as currencies are selected.
